...
def path_find():
	...
	jsonJunk = {'activityList': [{'activity': 'Dodger Stadium','latitude': 'lat','longitude': 'lon','type': 'attraction', 'pinned':'false'},{'activity': 'Huntington Beach','latitude': 'lat','longitude': 'lon','type': 'attraction', 'pinned':'false'},{'activity': 'Chipotle','latitude': 'lat','longitude': 'lon','type': 'food', 'pinned':'false'},{'activity': 'Uber1','latitude': 'lat','longitude': 'lon','type': 'transportation', 'pinned':'false'},{'activity': 'Uber2','latitude': 'lat','longitude': 'lon','type': 'transportation', 'pinned':'false'},{'activity': 'Griffith Observatory','latitude': 'lat','longitude': 'lon','type': 'attraction', 'pinned':'false'}],'itinerary': ['Griffith Observatory', 'Uber1', 'Chipotle', 'Uber2', 'Dodger Stadium']}
